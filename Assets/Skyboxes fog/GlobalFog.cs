...
//{
    ...
    public class GlobalFog : PostEffectsBase
	{
        ...
        void SetSkyboxHeight(float height) => this.height = height;
        void OnEnable() => Events.onSkyboxHeightChanged += SetSkyboxHeight;
        void OnDisable() => Events.onSkyboxHeightChanged -= SetSkyboxHeight;
//        [ImageEffectOpaque]
